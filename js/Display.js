  ...
  .then(properties => {
    ...
    properties.forEach(property => {
      ...
      propertyItem.innerHTML = `
        ...
        <div class="p-4 pb-0">
          <h5 class="text-primary mb-3">ETB ${property.price}</h5>
          <a class="d-block h5 mb-2" href="property-single.html?id=${property.id}">${property.title}</a>
          <p><i class="fa fa-map-marker-alt text-primary me-2"></i> ${property.streetAddress}, ${property.city}</p>
        </div>
        <div class="d-flex border-top">
          <small class="flex-fill text-center border-end py-2"><i class="fa fa-ruler-combined text-primary me-2"></i>${property.squareFootage}</small>
